...
def main():
    ...
    stability_threshold = 500  # Maximum movement in pixels to consider object stable
    stability_frames = 100  # Number of frames object must be stable to consider it stopped
...
def detect_and_track_object(cap, reference_frame, min_area, stability_threshold, stability_frames_threshold):
    ...
    if motion_detected and best_isolated_object is not None:
        print("Successfully captured moving object!")
        return best_isolated_object, final_frame
    else:
        print("Failed to capture a good isolated object.")
        return None, None
